...
/**
 * Abstract Person Class - Superclass for Patient and Doctor
 * 
 * Represents shared person structure in the hospital system.
 * Stores common attributes shared by all people (patients and doctors).
 * Because Person is abstract, the system cannot create a plain Person object.
 * It must create a concrete subclass such as Patient or Doctor.
 * 
 * This is a foundational class that demonstrates abstract inheritance:
 * - Patient extends Person (A patient IS a person)
 * - Doctor extends Person (A doctor IS a person)
 * - Person defines common fields and concrete methods
 * - Person also defines abstract methods that subclasses must implement
 * 
 * Access Modifiers:
...
public abstract class Person implements Displayable {
    ...
    /**
     * Gets the person's hospital role.
     * Abstract method: every concrete subclass must provide its own role.
     * @return Role name, such as "Doctor" or "Patient"
     */
    public abstract String getRole();

    /**
     * Displays common person information.
     * Concrete method: shared by all subclasses and reused with super.displayInfo().
     */
    @Override
